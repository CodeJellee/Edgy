...
const NewProductForm = () => {
    ...
    const onSubmit = async(e) => {
        ...
        // console.log('WHAT IS THIS', fetchResponseFromThunk)
        await dispatch(productActions.thunkGetSingleProduct(fetchResponseFromThunk.id))
        ...
        <form className="create-new-spot-form" onSubmit={onSubmit}>
            ...
            <div>
                ...
                <label>
                    <div className="label-and-error-info">
                        Item Name
                        {submitted && errors.itemName && <div className="errors">{errors.itemName}</div>}
                    </div>
            ...
            <div>
                ...
                <label>
                    <div className="label-and-error-info">
                        Price
                        {submitted && errors.price && <div className="errors">{errors.price}</div>}
                    </div>
            ...
            <div>
                ...
                <label>
                    <div className="label-and-error-info">
                        Category
                        {submitted && errors.category && <div className="errors">{errors.category}</div>}
                    </div>
            ...
            <div>
                ...
                <label>
                    <div className="label-and-error-info">
                        Description
                        {submitted && errors.description && <div className="errors">{errors.description}</div>}
                    </div>
            ...
            <div>
                ...
                <label>
                    <div className="label-and-error-info">
                        Quantity
                        {submitted && errors.quantity && <div className="errors">{errors.quantity}</div>}
                    </div>
            ...
            <div>
                ...
                <label>
                    <div className="label-and-error-info">
                        Preview Image
                        {submitted && errors.previewImageURL && <div className="errors">{errors.previewImageURL}</div>}
                    </div>
                    <input type="text" name="previewImageURL" placeholder="Preview Image URL" value={previewImageURL} onChange={(e) => setPreviewImageURL(e.target.value)} />
                </label>
            </div>
