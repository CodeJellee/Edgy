...
function ProductIdPage() {
  ...
  const [mainImage, setMainImage] = useState(
    "https://i.etsystatic.com/31560168/r/il/4336cd/4425918630/il_794xN.4425918630_38m9.jpg"
  );
  console.log(id);
      ...
      <div className="PID-product">
        <div className="PID-all-Images">
          <div className="PID-images-div">
            <img
              ...
              src="https://i.etsystatic.com/31560168/r/il/9b902f/4473276055/il_794xN.4473276055_fcxk.jpg"
              alt="filler 2"
            ></img>
            <img
              onClick={changeMainImage}
              src="https://i.etsystatic.com/31560168/r/il/2f8cab/4425918302/il_794xN.4425918302_1x8r.jpg"
              alt="filler 3"
            ></img>
            <img
              onClick={changeMainImage}
              src="https://i.etsystatic.com/31560168/r/il/401a30/4473276305/il_794xN.4473276305_qrxw.jpg"
              alt="filler 4"
            ></img>
          </div>
          <img
            className="PID-main-image"
            onClick={changeMainImage}
            src={mainImage}
            alt="filler"
          ></img>
        </div>
        <button className="PID-favButt" onclick={addToFav}>
          {" "}
        ...
        <div className="PID-about-product-div">
          ...
          <div className="PID-seller-avg-stars">
            ...
            <p className="Pid-ave-stars">reviews.stars.average</p>
          </div>
        </div>
