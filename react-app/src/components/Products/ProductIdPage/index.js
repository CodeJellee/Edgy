          ...
          <div className="PID-product">
            <div className="PID-all-Images">
              <div className="PID-images-div">
                <img
                  className="PID-small-img"
                  alt="product first loaded"
                  onClick={changeMainImage}
                  src={product.preview_imageURL}
                ></img>
              ...
              <div className="PID-main-image-div">
                <img
                  ...
                  onClick={changeMainImage}
                  src={mainImage || product.preview_imageURL}
                  alt="loading"
                ></img>
              </div>
            </div>
            ...
            <div className="PID-about-buttons-div">
              ...
              {user?.id ? (
                <div className="PID-buttons">
                  <button className="PID-buyNowButt PID-P-button PID-Transp-butt">
                    {" "}
                    <i class="fa-brands fas fa-cc-visa"></i> Buy it now
                  </button>
                  {/* <button className='PID-cartButt PID-P-button'>Add to cart</button> */}
                  <PutCartIemToCart
                    productId={product.id}
                    className="PID-cartButt PID-P-button"
                  />
                  <button
                    onClick={addToFav}
                  ...
                  >
                    ...
                    <i
                      onClick={addToFav}
                      className="fas fa-heart PID-heart"
                    />{" "}
                    Add to Favorites
                  </button>
                </div>
                ...
                <div lassName="PID-about-product-div">
                  Please log in or sign up to favorite or purchase the items!
                </div>
              )}
            </div>
            </div>
